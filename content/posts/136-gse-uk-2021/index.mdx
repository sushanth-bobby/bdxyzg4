...
![IBM z15 Functions and Features](./5av-z15-features.png)
...
![Parallel Sysplex Coupling Connectivity](./5av-z15-coupling-connectivity.png)
...
![Processor version codes and SRM constants](./6av-processor-version-codes.png)
...
![Db2 Connect License Options](./2ay-db2_connect_license.png)
...
![Db2 Client Connectivity products](./2ay-db2_drives.png)
...
![Db2 Data Server Drivers](./2ay-db2_ds_clients1.png)

![Db2 Data Server Drivers](./2ay-db2_ds_clients2.png)

![What driver to use](./2ay-what-to-use.png)

##### Db2 Connect Server aka Gateway 

![Db2 Connect Server](./2ay-db2_connect_server.png)
...
![Address space](./6bb-address_space.png)
...
![Pervasive Encryption](./5bc-pervasive_encryption.png)
...
![Shared data model](./4bj_parallel_sysplex_shared_data_model.png)
...
![Sysplex Components](./4bj_sysplex_components.png)
...
![CF Rebuild Types](./4bj_cf_rebuild_types.png)
