...
![Db2 Lock modes](./db2-locks-modes.png)
...
![Db2 Lock hierarchy](./db2-locks-hierarchy.png)
...
![Db2 Locks Compatibility Matrix](./db2-locks-compat-matrix-higher-scope-locks.png)
...
![Db2 Deadlocks](./db2-locks-deadlock.png)
