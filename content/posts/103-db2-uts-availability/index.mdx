...
![CREATES and ALTERS](./db2-multitable-move.png)
...
![Lock, Insert and PBG](./db2-lock-insert-pbg.png)
...
![Insert Flow](./db2-pbg-insert-flow.png)
...
![Member cluster 2](./db2-mc-2.png)

##### MEMBER CLUSTER space comparison

**Classic Partitioned tablespace**    

![Member cluster classic](./db2-mc-classic.png)
...
![Member cluster UTS](./db2-mc-uts.png)
...
![Insert Algorithm 2](./db2-iag2.png)
...
![Db2 PBG to PBR using ROWID](./db2-pbg-pbr-rowid.png)
...
![Table DDL](./db2-table-with-rowid.png)
