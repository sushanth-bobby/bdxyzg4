...
![Uniform Vs. Fine-Grain](./gcs-uniform-finegrain.png)
...
![Creates the folder in the root of the bucket itself](./gcs-no-path.png)
...
![File stored in Nearline storage class](./gcs-nearline.png)
...
![Cloud Shell](./gcs-cloud-shell.png)
